/**
 * 高解像度版(32x48) キャラクター・モンスターSVGアセット
 * 主人公：男性(Cool)、女性(Cute/Sexy)
 * モンスター：低ランク(Cute)、高ランク(Strong)
 */
export const ASSETS_SVG = {
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M11 18h10v2H11z" fill="#ffd700" />
    <path d="M6 18h3v12H6zm23 18h3v12h-3z" fill="#90a4ae" />
    <path d="M10 4h12v12H10z" fill="#ffccaa" />
    <path d="M9 2h14v8H9z" fill="#cfd8dc" />
    <path d="M12 10h2v2h-2zm6 0h2v2h-2z" fill="#1565c0" />
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 16h18v10H7z" fill="#ffccaa" />
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10 18h3v2h-3zm9 0h3v2h-3z" fill="#90a4ae" />
    <path d="M14 20h4v6H14z" fill="#ffdbbd" />
    <path d="M11 26h10v4H11z" fill="#90a4ae" />
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 14h8v4h-8z" fill="#558b2f" />
    <path d="M13 10h2v2h-2zm4 0h2v2h-2z" fill="#000" />
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M11 24h10v4H11z" fill="#2e7d32" />
    <path d="M11 28h4v16h-4zm6 0h4v16h-4z" fill="#ffdbbd" />
    <path d="M10 38h6v6h-6zm6 0h6v6h-6z" fill="#4e342e" />
  </svg>`,
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 8h8v8H12z" fill="#ffdbbd" />
    <path d="M14 11h4v1H14z" fill="#000" opacity="0.3" />
    <path d="M8 16h16v24H8z" fill="#311b92" />
    <path d="M10 16h12v24H10z" fill="#4527a0" />
    <path d="M15 16h2v24h-2z" fill="#ffd700" opacity="0.5" />
  ...
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10 18h12v3H10z" fill="#ffdbbd" />
    <path d="M10 21h12v20H10z" fill="#880e4f" />
    <path d="M17 28h5v12h-5z" fill="#ffdbbd" />
    <path d="M11 41h10v2H11z" fill="#4a148c" />
    <path d="M26 10h2v30h-2z" fill="#5d4037" />
    <circle cx="27" cy="8" r="3" fill="#ea80fc" />
  </svg>`,

  // --- Monster: Low Rank (Cute/Weak) ---
  Monster_Slime: `
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="16" cy="28" rx="12" ry="3" fill="rgba(0,0,0,0.1)" />
    <path d="M6 24c0-8 4-14 10-14s10 6 10 14-4 4-10 4-10-4-10-4z" fill="#4fc3f7" />
    <path d="M10 20c0-6 3-10 6-10s6 4 6 10h-12z" fill="#81d4fa" />
    <circle cx="13" cy="20" r="1.5" fill="#fff" />
    <circle cx="19" cy="20" r="1.5" fill="#fff" />
    <path d="M14 24a2 2 0 0 0 4 0" fill="none" stroke="#fff" stroke-width="1" />
  </svg>`,
  ...
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- 茎 -->
    <path d="M12 20h8v8h-8z" fill="#f5f5f5" />
    <!-- 傘 -->
    <path d="M6 20c0-6 4-10 10-10s10 4 10 10H6z" fill="#ef5350" />
    <circle cx="11" cy="14" r="2" fill="#fff" opacity="0.6" />
    <circle cx="21" cy="15" r="1.5" fill="#fff" opacity="0.6" />
    <!-- 顔 -->
    <circle cx="14" cy="24" r="1" fill="#333" />
    <circle cx="18" cy="24" r="1" fill="#333" />
  </svg>`,

  // --- Monster: High Rank (Cool/Strong) ---
  Monster_Dragon: `
  <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="24" cy="44" rx="16" ry="4" fill="rgba(0,0,0,0.2)" />
    <!-- 翼 -->
    <path d="M24 20 L4 4 L14 24 L4 34 L24 30 Z" fill="#4a148c" />
    <path d="M24 20 L44 4 L34 24 L44 34 L24 30 Z" fill="#4a148c" />
    <!-- 胴体 -->
    <path d="M16 16h16v24H16z" fill="#311b92" />
    <path d="M18 18h12v20H18z" fill="#4527a0" />
    <!-- 棘 -->
    <path d="M14 20l2 2-2 2zm18 0l2 2-2 2z" fill="#7b1fa2" />
    <!-- 頭部 -->
    <path d="M20 8h8v10h-8z" fill="#311b92" />
    <path d="M18 10l2-2h8l2 2v6l-2 2h-8l-2-2z" fill="#4527a0" />
    <path d="M21 12h2v2h-2zm4 0h2v2h-2z" fill="#ffeb3b" /> <!-- 輝く瞳 -->
    <path d="M20 16h8v2h-8z" fill="#1a237e" />
  </svg>`,

  Monster_DemonKnight: `
  <svg viewBox="0 0 32 48" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="16" cy="44" rx="12" ry="4" fill="rgba(0,0,0,0.3)" />
    <!-- マント -->
    <path d="M6 14h20v24L16 44 6 38z" fill="#212121" />
    <path d="M6 14h20v4H6z" fill="#b71c1c" />
    <!-- 鎧 -->
    <path d="M9 12h14v24H9z" fill="#121212" />
    <path d="M10 14h12v20H10z" fill="#263238" />
    <!-- 兜 -->
    <path d="M11 4h10v10H11z" fill="#121212" />
    <path d="M13 8h6v2h-6z" fill="#f44336" /> <!-- 赤い眼光 -->
    <!-- 大剣 -->
    <path d="M24 10h3v30l-1.5 4L24 40z" fill="#424242" />
    <path d="M23 32h5v3h-5z" fill="#212121" />
  </svg>`
};
